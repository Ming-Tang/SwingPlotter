...
var routes = {
    ...
    scripts: {
        ...
        js: [baseDirs.src+'scripts/gpu.js', baseDirs.src+'scripts/index.js'],
...
gulp.task('data', function() {
    gulp.src(routes.files.data + "/*")
        .pipe(gulp.dest(routes.files.dataout))
...
gulp.task('serve', function() {
    ...
    gulp.watch(routes.files.data + "/*", ['data']);
});
...
gulp.task('dev', ['templates', 'styles', 'scripts', 'images', 'serve', 'data']);

gulp.task('build', ['templates', 'styles', 'scripts', 'images', 'data']);
